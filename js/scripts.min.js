...
$(function(){var e,o;$(document).ready(function(){$(".preloader").delay(2e3).fadeOut("slow")}),$(document).ready(function(){svg4everybody({})}),$(document).ready(function(){$("img, a").on("dragstart",function(e){e.preventDefault()})}),$(window).scroll(function(e){$(this).scrollTop()>$(this).height()?($(".to-top").addClass("visible"),$(".to-top").removeClass("hidden")):($(".to-top").removeClass("visible"),$(".to-top").addClass("hidden")),$(".to-top").click(function(e){$("html, body").stop().animate({scrollTop:0},"slow")})}),$(document).ready(function(){var e;$(".head-search a").on("click",(e=1,function(){1===e?(e=2,$(".head-search input").css("transform","translateY(0)")):2===e&&(e=1,$(".head-search input").css("transform","translateY(1000%)"))}))}),$(document).ready(function(){var e;$(".trigger").on("click",(e=1,function(){1===e?(e=2,$(".header-nav ul").css("left","0")):2===e&&(e=1,$(".header-nav ul").css("left","-200%"))}))}),$(document).ready(function(){$(".post-slider").slick({slidesToShow:1,slidesToScroll:1,fade:!0,arrows:!0}),$(".related-slider").slick({slidesToShow:3,responsive:[{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:1,infinite:!0}},{breakpoint:400,settings:{slidesToShow:1,slidesToScroll:1,infinite:!0}}]})}),e=document.getElementById("sc-widget"),(o=SC.Widget(e)).bind(SC.Widget.Events.READY,function(){o.bind(SC.Widget.Events.FINISH,function(){o.load("http://api.soundcloud.com/tracks/13692671",{show_artwork:!1})})})});